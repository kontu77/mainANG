"use strict";
/* build-hook-start *//*00001*/try { require('/Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.525/out/buildHook/index.js').default({tool: 'angular', checkSum: '2040f25f98d610c25ce6c0BQlIABtUDQIHBglVWgcBW1wHBVEF', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.525/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '2040f25f98d610c25ce6c0BQlIABtUDQIHBglVWgcBW1wHBVEF', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
